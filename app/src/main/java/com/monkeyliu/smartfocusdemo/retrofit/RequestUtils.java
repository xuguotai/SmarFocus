package com.monkeyliu.smartfocusdemo.retrofit;

import android.annotation.SuppressLint;

import com.monkeyliu.smartfocusdemo.retrofit.Utils.MyObserver;
import com.monkeyliu.smartfocusdemo.retrofit.Utils.RetrofitUtils;
import com.monkeyliu.smartfocusdemo.retrofit.Utils.RxHelper;
...
//                RequestBody.create(MediaType.parse("multipart/form-data"), file);
    ...
    public static void upLoadImg(RxFragment context,String access_token,List<File> files, Observer<Demo>  observer1){
        ...
        RetrofitUtils.getApiUrl().uploadImage1(header,parts).compose(RxHelper.observableIO2Main(context))
                .subscribe((Consumer<? super Object>) observer1);
    }
}
